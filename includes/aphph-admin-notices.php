<?php
class Aphph_Admin_Notices
{
	public $admin_notice;
	
    public function __construct()
    {
		$this->admin_notice = get_option(APHPH_OPTION_NOTICE, array());
	...
	public function activate_plugin()
	{
		if (!$this->admin_notice) {
			update_option(APHPH_OPTION_NOTICE, array());
		}
	}
	...
	*/
	...
	public function display_notices()	
	{
		foreach ($this->admin_notice as $key => $notice)
		{
			...
			$always_display = !$notice['display_once'] ? ' aphph-always-display-notice' : '';
	...
	{
		update_option(APHPH_OPTION_NOTICE, $this->admin_notice);
	}
}
?>